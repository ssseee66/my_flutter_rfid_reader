...
public class MyListener {
    ...
    private void setAction_map() {
        actionMap.put("startConnect",             this :: startConnect);
        actionMap.put("closeConnect",             this :: closeConnect);
        actionMap.put("turnOnPower",              this :: turnOnPower);
        actionMap.put("turnOffPower",             this :: turnOffPower);
        actionMap.put("querySerialNumber",        this :: querySerialNumber);
        actionMap.put("startReader",              this :: startReader);
        actionMap.put("startReaderEpc",           this :: startReaderEpc);
        actionMap.put("readerOver",               this :: readerOver);
        actionMap.put("writeEpcData",             this :: writeEpcData);
        actionMap.put("startListenerBroadcast",   this :: startListenerBroadcast);
        actionMap.put("stopListenerBroadcast",    this :: stopListenerBroadcast);
    ...
    private void startConnect(String key) {
        ...
        messageChannel.send(message_map);
    }
    ...
    private void setWriteMessage(byte code) {
        String write_code = "writeDataCode";
